...
public class Category {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pos_category_seq")
    @SequenceGenerator(name = "pos_category_seq", sequenceName = "pos_category_seq", allocationSize = 1)
    private Long catId;
